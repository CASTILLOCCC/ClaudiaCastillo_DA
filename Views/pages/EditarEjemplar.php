                      ...
                      <div class="azul1 col-12">
                                    ...
                                    <div class="form-group">
                                      <div class="col-md-12  text-center">
                                        ...
                                        <input id="CodigoEjemplar" name="codigoEjemplar" type="text" value="<?php echo $_GET['id'] ?>" readonly class="form-control text-center" >
                                    </div>
                                        <div class="col-md-12  text-center">
                                    ...
                                    ?>
                                        ...
                                        <input type="hidden" name="controller" value="updateejemplar">
                                    </div>
