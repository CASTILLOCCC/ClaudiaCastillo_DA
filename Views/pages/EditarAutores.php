                      ...
                      <div class="azul1 col-12">
                                    ...
                                    <div class="form-group">
                                      <div class="col-md-12  text-center">
                                        ...
                                        <input id="CodigoAutor" name="CodigoAutor" type="text"  value="<?php echo $_GET['id'] ?>" readonly class="form-control text-center" >
                                    </div>
                                        <div class="col-md-12  text-center">
                                        
                                            <input id="NombreAutor" name="NombreAutor" type="text" placeholder="Nombre del Autor" class="form-control text-center" >
                                            <input type="hidden" name="controller" value="updateautor">
                                        </div>
                                      </div>
